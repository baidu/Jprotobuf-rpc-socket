...
public class RpcChannelErrorException extends Exception {
     ...
     */
    public RpcChannelErrorException(String message, Throwable cause, int errorCode) {
        super(message, cause);
        this.errorCode = errorCode;
    }
     ...
     * @param message the message
     */
    public RpcChannelErrorException(String message) {
        super(message);
    }
     ...
     * @param errorCode the error code
     */
    public RpcChannelErrorException(String message, int errorCode) {
        super(message);
        this.errorCode = errorCode;
    }
     ...
     * @param cause the cause
     */
    public RpcChannelErrorException(Throwable cause) {
        super(cause);
    }
     ...
     * @param errorCode the error code
     */
    public RpcChannelErrorException(Throwable cause, int errorCode) {
        super(cause);
        this.errorCode = errorCode;
    }
